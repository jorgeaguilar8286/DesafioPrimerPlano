...
import cl.jav.desafioprimerplano.MainActivity
import cl.jav.desafioprimerplano.R
...
class ForegroundService: Service() {
    ...
    private fun createNotificationChannel(input: String) {
        ...
        val notificationIntent = Intent( this , git initMainActivity:: class . java )
